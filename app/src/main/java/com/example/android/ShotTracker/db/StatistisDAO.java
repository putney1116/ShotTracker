...
public class StatistisDAO extends ShotTrackerDBDAO {
    ...
    /**
     * Get the number of holes for which score - par is greater than diff
     * @param par
     * @param diff
     * @param player
     * @return
     */
    public int getNHolesParGreaterThanScore(int par, int diff, Player player) {
    ...
    /**
     * Get the number of holes with score - par > diff
     * @param par
     * @param diff
     * @param player
     * @param round
     * @return
     */
    public int getNHolesParGreaterThanScore(int par, int diff, Player player, Round round) {
        String queryScore = "SELECT "
                + DataBaseHelper.PAR_COLUMN
                + " FROM "
                + DataBaseHelper.ROUNDHOLE_TABLE
     ...
     * @return
     */
    public int getNHolesParGreaterThanScore(int par, int diff, Player player, Course course) {
        //build a query to get the total number of holes
        //player with a certain par, given a course ID
